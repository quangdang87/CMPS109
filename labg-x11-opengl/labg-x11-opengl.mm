...
.INITR* \n[.F]
.SIZE 12 14
.TITLE CMPS-109 Winter\~2019 Lab\~GL "X11 and OpenGL"
.RCS "$Id: labg-x11-opengl.mm,v 1.207 2019-04-24 17:15:32-07 - - $"
.PWD
.URL
.nr HISTORY 0 1
.de PROMPT
.   TVCODE* 1 "bash-\\n+[HISTORY]\[Do] " "\\$*"
..
This is a non-credit lab,
in preparation for an upcoming project which
...
.\"""".P
.\""""X2Go allows you to access a remote graphical desktop
.\""""over a low bandwidth connection.
.\""""In otherwords,
.\""""you can use X2Go to login to the Unix timeshare
.\""""in a graphical fashion instead of using a command line.
.\""""It is similar to the X11 (or XWindows)
.\""""system that use XDMCP (or SSH) to view a remote desktop.
.\""""X2Go is availble on multiple platforms,
.\""""so simply pick the client that works best for you.
...
.P
An X11 window dump of this
program is shown at the end of this document
(Postscript and PDF versions only).
.H 1 "Problems?"
...
.TVCODE* 1 "necessary capabilities not found> in function fgOpenWindow"
The following statement in your
.V= \&.bash_profile
might solve that problem\(::
.VTCODE* 1 \
"export GLESLIB=/usr/local/android-sdk/emulator/lib64/gles_mesa
.VTCODE* 1 "export\0LD_LIBRARY_PATH=\[Do]LD_LIBRARY_PATH:\[Do]GLESLIB
.H 1 "Other tests"
...
.DE
.DS
.PSPIC hello-world/bonjour-le-monde.xwd.ps 210p
.PSPIC hello-world/ciao-mondo.xwd.ps 210p
.PSPIC hello-world/hallo-welt.xwd.ps 210p
.PSPIC hello-world/konnichiwa-sekai.xwd.ps 210p
.DE
.\}
